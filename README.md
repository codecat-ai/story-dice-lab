...
Maturity: `growth`. Planned cadence: 1-2 focused sessions per week while classroom/workshop workflows are still being hardened; review for `maintenance` after the demo walkthrough workflow is complete.
